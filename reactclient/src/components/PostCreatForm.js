...
export default function PostCreatForm(props) {
  const initialFormData = Object.freeze({
    title: "Post X",
    content:
      "This is post x and it has some very interesting content. This videio is good so far.",
  });
  ...
  const handleSubmit = (e) => {
    ...
    const postToCreate = {
      postId: 0, //server will handle the post id
